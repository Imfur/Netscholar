...
<body>
  ...
  <div class="container" style="padding-top: 180px;">
    ...
    ?>
    <a href="add_new_ad.php" class="btn btn-dark mb-3">Add New</a>
      ...
      <tbody>
        ...
        ?>
          ...
          <td><?php echo $row["ID"]?></td>
            ...
            <td>
            <a href="edit_ad.php?id=<?php echo $row["ID"] ?>" class="link-dark"><i class="fa-solid fa-pen-to-square fs-5 me-3"></i></a>
              <a href="delete_ad.php?id=<?php echo $row["ID"] ?>" class="link-dark"><i class="fa-solid fa-trash fs-5"></i></a>
            </td>
          </tr>
        <?php
        }
