...
if (isset($_POST["submit"])) {
    ...
    $link = $_POST['link'];
    $newImageName = ""; // Initialize the variable
    ...
    $sql = "INSERT INTO `product`(`Name`, `agent`, `price`, `county`, `category`, `details`, `image`,`link`) VALUES ('$name','$agent','$price','$county','$category','$details','$newImageName','$link')";
